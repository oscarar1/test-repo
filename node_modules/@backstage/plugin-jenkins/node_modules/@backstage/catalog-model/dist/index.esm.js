...
var $id$d = "EntityEnvelope";
var description$d = "The envelope skeleton parts of an entity - whatever is necessary to be able to give it a ref and pass to further validation / policy checking.";
var examples$c = [
	{
...
var $id$c = "Entity";
var description$c = "The parts of the format that's common to all versions/kinds of entity.";
var examples$b = [
	{
		apiVersion: "backstage.io/v1alpha1",
		kind: "Component",
...
var $id$b = "EntityMeta";
var description$b = "Metadata fields common to all versions/kinds of entity.";
var examples$a = [
	{
...
var $id$a = "common";
var type = "object";
var description$a = "Common definitions to import from other schemas";
var definitions = {
	reference: {
		$id: "#reference",
		type: "object",
...
var $id$9 = "ApiV1alpha1";
var description$9 = "An API describes an interface that can be exposed by a component. The API can be defined in different formats, like OpenAPI, AsyncAPI, GraphQL, gRPC, or other formats.";
var examples$9 = [
	{
		apiVersion: "backstage.io/v1alpha1",
		kind: "API",
...
const apiEntityV1alpha1Validator = ajvCompiledJsonSchemaValidator(schema$9);

var $schema$8 = "http://json-schema.org/draft-07/schema";
var $id$8 = "ComponentV1alpha1";
var description$8 = "A Component describes a software component. It is typically intimately linked to the source code that constitutes the component, and should be what a developer may regard a \"unit of software\", usually with a distinct deployable or linkable artifact.";
var examples$8 = [
	{
		apiVersion: "backstage.io/v1alpha1",
		kind: "Component",
...
const componentEntityV1alpha1Validator = ajvCompiledJsonSchemaValidator(schema$8);

var $schema$7 = "http://json-schema.org/draft-07/schema";
var $id$7 = "DomainV1alpha1";
var description$7 = "A Domain groups a collection of systems that share terminology, domain models, business purpose, or documentation, i.e. form a bounded context.";
var examples$7 = [
	{
		apiVersion: "backstage.io/v1alpha1",
		kind: "Domain",
...
const domainEntityV1alpha1Validator = ajvCompiledJsonSchemaValidator(schema$7);
...
const groupEntityV1alpha1Validator = ajvCompiledJsonSchemaValidator(schema$6);

var $schema$5 = "http://json-schema.org/draft-07/schema";
var $id$5 = "LocationV1alpha1";
var description$5 = "A location is a marker that references other places to look for catalog data.";
var examples$5 = [
	{
		apiVersion: "backstage.io/v1alpha1",
		kind: "Location",
...
const locationEntityV1alpha1Validator = ajvCompiledJsonSchemaValidator(schema$5);
...
var $id$4 = "ResourceV1alpha1";
var description$4 = "A resource describes the infrastructure a system needs to operate, like BigTable databases, Pub/Sub topics, S3 buckets or CDNs. Modelling them together with components and systems allows to visualize resource footprint, and create tooling around them.";
var examples$4 = [
	{
		apiVersion: "backstage.io/v1alpha1",
		kind: "Resource",
...
const resourceEntityV1alpha1Validator = ajvCompiledJsonSchemaValidator(schema$4);

var $schema$3 = "http://json-schema.org/draft-07/schema";
var $id$3 = "SystemV1alpha1";
var description$3 = "A system is a collection of resources and components. The system may expose or consume one or several APIs. It is viewed as abstraction level that provides potential consumers insights into exposed features without needing a too detailed view into the details of all components. This also gives the owning team the possibility to decide about published artifacts and APIs.";
var examples$3 = [
	{
		apiVersion: "backstage.io/v1alpha1",
		kind: "System",
...
const systemEntityV1alpha1Validator = ajvCompiledJsonSchemaValidator(schema$3);

var $schema$2 = "http://json-schema.org/draft-07/schema";
var $id$2 = "TemplateV1alpha1";
var description$2 = "A Template describes a skeleton for use with the Scaffolder. It is used for describing what templating library is supported, and also for documenting the variables that the template requires using JSON Forms Schema.";
var examples$2 = [
	{
		apiVersion: "backstage.io/v1alpha1",
		kind: "Template",
...
const templateEntityV1alpha1Validator = ajvCompiledJsonSchemaValidator(schema$2);
