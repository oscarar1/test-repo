...
import React__default, { CSSProperties, ElementType, ReactNode, PropsWithChildren, ComponentType, ComponentClass, ErrorInfo, ReactElement, ComponentProps } from 'react';
...
declare type Selection$1 = {
    category?: string;
    selectedChildren?: string[];
}[];
declare type CheckboxTreeProps = {
    subCategories: SubCategory[];
    label: string;
    triggerReset?: boolean;
    selected?: Selection$1;
    onChange: (arg: Selection$1) => any;
};
declare const CheckboxTree: ({ subCategories, label, selected, onChange, triggerReset, }: CheckboxTreeProps) => JSX.Element;
...
declare const CodeSnippet: ({ text, language, showLineNumbers, showCopyCodeButton, highlightedNumbers, customStyle, }: Props$q) => JSX.Element;
...
declare const DismissableBanner: ({ variant, message, id, fixed, }: Props$o) => JSX.Element;
...
declare const EmptyState: ({ title, description, missing, action }: Props$n) => JSX.Element;

declare type Props$m = {
    annotation: string;
};
declare const MissingAnnotationEmptyState: ({ annotation }: Props$m) => JSX.Element;
 ...
 */
declare const ResponseErrorDetails: ({ error }: Props$l) => JSX.Element;
/**
 ...
 * server-provided information about what happened.
 */
declare const ResponseErrorPanel: ({ error }: Props$l) => JSX.Element;
...
declare const FeatureCalloutCircular: ({ featureId, title, description, children, }: PropsWithChildren<Props$k>) => JSX.Element;
...
declare const HeaderIconLinkRow: ({ links }: Props$j) => JSX.Element;
...
declare const HorizontalScrollGrid: (props: PropsWithChildren<Props$i>) => JSX.Element;

declare type Props$h = CSS.Properties & {
    shorthand?: boolean;
    alpha?: boolean;
};
declare const Lifecycle: (props: Props$h) => JSX.Element;
 ...
 */
declare const MarkdownContent: ({ content, dialect }: Props$g) => JSX.Element;
...
declare const OverflowTooltip: (props: Props$f) => JSX.Element;
...
declare const InfoCard: ({ title, subheader, divider, deepLink, slackChannel, variant, children, headerStyle, headerProps, actionsClassName, actions, cardClassName, actionsTopRight, className, noPadding, titleTypographyProps, }: Props$e) => JSX.Element;
...
declare const GaugeCard: (props: Props$d) => JSX.Element;
...
declare const Gauge: (props: Props$c) => JSX.Element;
...
declare const LinearGauge: ({ value }: Props$b) => JSX.Element | null;
...
declare const StructuredMetadataTable: ({ metadata, dense, options, }: Props$a) => JSX.Element;

declare type Props$9 = {};
declare const SupportButton: ({ children }: PropsWithChildren<Props$9>) => JSX.Element;
 ...
 */
declare const WarningPanel: (props: Props$8) => JSX.Element;
...
declare const Content: ({ className, stretch, noPadding, children, ...props }: PropsWithChildren<Props$7>) => JSX.Element;
...
declare const ErrorBoundary: ComponentClass<Props$6, State>;
...
declare const TabbedCard: ({ slackChannel, children, title, deepLink, value, onChange, }: PropsWithChildren<Props$1>) => JSX.Element;
