...
function getEntityMetadataViewUrl(entity) {
  var _a;
  return (_a = entity.metadata.annotations) == null ? void 0 : _a[catalogModel.VIEW_URL_ANNOTATION];
}
function getEntityMetadataEditUrl(entity) {
  var _a;
  return (_a = entity.metadata.annotations) == null ? void 0 : _a[catalogModel.EDIT_URL_ANNOTATION];
}
...
function getEntitySourceLocation(entity, scmIntegrationsApi) {
  var _a;
  const sourceLocation = (_a = entity.metadata.annotations) == null ? void 0 : _a[catalogModel.SOURCE_LOCATION_ANNOTATION];
  if (!sourceLocation) {
    return void 0;
  }
  try {
    const sourceLocationRef = catalogModel.parseLocationReference(sourceLocation);
...
class EntityOwnerFilter {
  ...
  filterEntity(entity) {
    return this.values.some((v) => getEntityRelations(entity, catalogModel.RELATION_OWNED_BY).some((o) => formatEntityRefTitle(o, {defaultKind: "group"}) === v));
  }
}
...
const checkedIcon$2 = /* @__PURE__ */ React__default['default'].createElement(CheckBoxIcon__default['default'], {
  fontSize: "small"
});
const EntityLifecyclePicker = () => {
  var _a, _b;
  const {updateFilters, backendEntities, filters} = useEntityListProvider();
  const availableLifecycles = React.useMemo(() => [
  ...
  return /* @__PURE__ */ React__default['default'].createElement(core$1.Box, {
    ...
    variant: "button"
  }, "Lifecycle"), /* @__PURE__ */ React__default['default'].createElement(lab.Autocomplete, {
    multiple: true,
...
const checkedIcon$1 = /* @__PURE__ */ React__default['default'].createElement(CheckBoxIcon__default['default'], {
  fontSize: "small"
});
const EntityOwnerPicker = () => {
  ...
  const availableOwners = React.useMemo(() => [
    ...new Set(backendEntities.flatMap((e) => getEntityRelations(e, catalogModel.RELATION_OWNED_BY).map((o) => formatEntityRefTitle(o, {defaultKind: "group"}))).filter(Boolean))
  ].sort(), [backendEntities]);
  ...
  return /* @__PURE__ */ React__default['default'].createElement(core$1.Box, {
    ...
    variant: "button"
  }, "Owner"), /* @__PURE__ */ React__default['default'].createElement(lab.Autocomplete, {
    multiple: true,
...
exports.EntityLifecycleFilter = EntityLifecycleFilter;
exports.EntityLifecyclePicker = EntityLifecyclePicker;
exports.EntityListContext = EntityListContext;
exports.EntityListProvider = EntityListProvider;
exports.EntityOwnerFilter = EntityOwnerFilter;
exports.EntityOwnerPicker = EntityOwnerPicker;
...
exports.getEntityMetadataEditUrl = getEntityMetadataEditUrl;
exports.getEntityMetadataViewUrl = getEntityMetadataViewUrl;
