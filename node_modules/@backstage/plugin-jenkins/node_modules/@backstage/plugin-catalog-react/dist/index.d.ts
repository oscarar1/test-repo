...
import { LinkProps, TableColumn } from '@backstage/core';
...
declare const EntityContext: React.Context<EntityLoadingStatus>;
...
declare const rootRoute: _backstage_core.RouteRef<undefined>;
declare const catalogRouteRef: _backstage_core.RouteRef<undefined>;
declare const entityRoute: _backstage_core.RouteRef<{
    name: string;
    kind: string;
    namespace: string;
}>;
declare const entityRouteRef: _backstage_core.RouteRef<{
    name: string;
    kind: string;
    namespace: string;
}>;
...
declare const MockEntityListContextProvider: ({ children, value, }: React__default.PropsWithChildren<{
