      ...
      lazy: () => component().then((InnerComponent) => {
        const RoutableExtensionWrapper = (props) => {
          try {
            ...
            throw new Error("Routable extension component was not discovered in the app element tree. Routable extension components may not be rendered by other components and must be directly available as an element within the App provider component.");
          }
