...
declare function createRoutableExtension<T extends (props: any) => JSX.Element>(options: {
    component: () => Promise<T>;
    mountPoint: RouteRef;
}): Extension<T>;
declare function createComponentExtension<T extends (props: any) => JSX.Element>(options: {
    component: ComponentLoader<T>;
}): Extension<T>;
declare function createReactExtension<T extends (props: any) => JSX.Element>(options: {
    component: ComponentLoader<T>;
