...
import { RouteRef as RouteRef$1 } from '@backstage/core-plugin-api';
...
declare type RouteRefType = Exclude<keyof RouteRef$1, 'params' | 'path' | 'title' | 'icon'>;
declare const routeRefType: RouteRefType;
