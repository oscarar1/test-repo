...
import { Logger, Logform, LoggerOptions } from 'winston';
...
import { MergeResult, PushResult, ReadCommitResult } from 'isomorphic-git';
 ...
 */
declare class SingleConnectionDatabaseManager {
...
declare const coloredFormat: Logform.Format;

declare function getRootLogger(): Logger;
declare function setRootLogger(newLogger: Logger): void;
declare function createRootLogger(options?: LoggerOptions, env?: NodeJS.ProcessEnv): Logger;
