...
var $id = "EntityEnvelope";
var description = "The envelope skeleton parts of an entity - whatever is necessary to be able to give it a ref and pass to further validation / policy checking.";
var examples = [
	{
...
var $id$1 = "Entity";
var description$1 = "The parts of the format that's common to all versions/kinds of entity.";
var examples$1 = [
	{
		apiVersion: "backstage.io/v1alpha1",
		kind: "Component",
...
var $id$2 = "EntityMeta";
var description$2 = "Metadata fields common to all versions/kinds of entity.";
var examples$2 = [
	{
...
var $id$3 = "common";
var type$3 = "object";
var description$3 = "Common definitions to import from other schemas";
var definitions = {
	reference: {
		$id: "#reference",
		type: "object",
...
var $id$4 = "ApiV1alpha1";
var description$4 = "An API describes an interface that can be exposed by a component. The API can be defined in different formats, like OpenAPI, AsyncAPI, GraphQL, gRPC, or other formats.";
var examples$3 = [
	{
		apiVersion: "backstage.io/v1alpha1",
		kind: "API",
...
const apiEntityV1alpha1Validator = ajvCompiledJsonSchemaValidator(schema);

var $schema$5 = "http://json-schema.org/draft-07/schema";
var $id$5 = "ComponentV1alpha1";
var description$5 = "A Component describes a software component. It is typically intimately linked to the source code that constitutes the component, and should be what a developer may regard a \"unit of software\", usually with a distinct deployable or linkable artifact.";
var examples$4 = [
	{
		apiVersion: "backstage.io/v1alpha1",
		kind: "Component",
...
const componentEntityV1alpha1Validator = ajvCompiledJsonSchemaValidator(schema$1);
...
const domainEntityV1alpha1Validator = ajvCompiledJsonSchemaValidator(schema$2);

var $schema$7 = "http://json-schema.org/draft-07/schema";
var $id$7 = "GroupV1alpha1";
var description$7 = "A group describes an organizational entity, such as for example a team, a business unit, or a loose collection of people in an interest group. Members of these groups are modeled in the catalog as kind User.";
var examples$6 = [
	{
		apiVersion: "backstage.io/v1alpha1",
		kind: "Group",
...
const groupEntityV1alpha1Validator = ajvCompiledJsonSchemaValidator(schema$3);

var $schema$8 = "http://json-schema.org/draft-07/schema";
var $id$8 = "LocationV1alpha1";
var description$8 = "A location is a marker that references other places to look for catalog data.";
var examples$7 = [
	{
		apiVersion: "backstage.io/v1alpha1",
		kind: "Location",
...
var $id$9 = "ResourceV1alpha1";
var description$9 = "A resource describes the infrastructure a system needs to operate, like BigTable databases, Pub/Sub topics, S3 buckets or CDNs. Modelling them together with components and systems allows to visualize resource footprint, and create tooling around them.";
var examples$8 = [
	{
		apiVersion: "backstage.io/v1alpha1",
		kind: "Resource",
...
const resourceEntityV1alpha1Validator = ajvCompiledJsonSchemaValidator(schema$5);

var $schema$a = "http://json-schema.org/draft-07/schema";
var $id$a = "SystemV1alpha1";
var description$a = "A system is a collection of resources and components. The system may expose or consume one or several APIs. It is viewed as abstraction level that provides potential consumers insights into exposed features without needing a too detailed view into the details of all components. This also gives the owning team the possibility to decide about published artifacts and APIs.";
var examples$9 = [
	{
		apiVersion: "backstage.io/v1alpha1",
		kind: "System",
...
const systemEntityV1alpha1Validator = ajvCompiledJsonSchemaValidator(schema$6);

var $schema$b = "http://json-schema.org/draft-07/schema";
var $id$b = "TemplateV1alpha1";
var description$b = "A Template describes a skeleton for use with the Scaffolder. It is used for describing what templating library is supported, and also for documenting the variables that the template requires using JSON Forms Schema.";
var examples$a = [
	{
		apiVersion: "backstage.io/v1alpha1",
		kind: "Template",
...
const templateEntityV1alpha1Validator = ajvCompiledJsonSchemaValidator(schema$7);

var $schema$c = "http://json-schema.org/draft-07/schema";
var $id$c = "TemplateV1beta1";
var description$c = "A Template describes a scaffolding task for use with the Scaffolder. It describes the required parameters as well as a series of steps that will be taken to execute the scaffolding task.";
var examples$b = [
	{
...
const templateEntityV1beta2Validator = ajvCompiledJsonSchemaValidator(schema$8);

var $schema$d = "http://json-schema.org/draft-07/schema";
var $id$d = "UserV1alpha1";
var description$d = "A user describes a person, such as an employee, a contractor, or similar. Users belong to Group entities in the catalog. These catalog user entries are connected to the way that authentication within the Backstage ecosystem works. See the auth section of the docs for a discussion of these concepts.";
var examples$c = [
	{
		apiVersion: "backstage.io/v1alpha1",
		kind: "User",
...
const userEntityV1alpha1Validator = ajvCompiledJsonSchemaValidator(schema$9);
