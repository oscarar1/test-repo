import { createApiRef, createRouteRef, createPlugin, createApiFactory, createRoutableExtension, MarkdownContent, Progress, useApi, errorApiRef, Page, Header, Content, ContentHeader, SupportButton } from '@backstage/core';
...
export { RadarPage as Router, RadarComponent as TechRadarComponent, TechRadarPage, techRadarPlugin as plugin, techRadarApiRef, techRadarPlugin };
