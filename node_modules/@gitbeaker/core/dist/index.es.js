...
class ResourceAwardEmojis extends BaseService {
  constructor(resourceType, options) {
...
class ResourceNoteAwardEmojis extends BaseService {
  constructor(resourceType, options) {
...
class ResourceDeployTokens extends BaseService {
  constructor(resourceType, options) {
...
class GroupRunners extends BaseService {
  all(groupId, options) {
    const gId = encodeURIComponent(groupId);
...
class UserSSHKeys extends BaseService {
  all(_a = {}) {
...
class FreezePeriods extends BaseService {
  all(projectId, options) {
    const pId = encodeURIComponent(projectId);
...
class MergeRequestApprovals extends BaseService {
...
class License extends BaseService {
  add(license, options) {
